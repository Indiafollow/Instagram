...
$me = null;
foreach ($users as $u) { if ($u['id'] === $_SESSION['user_id']) { $me = $u; break; } }
?>
...
<?php if (($me['role'] ?? 'user') === 'admin'): ?><a class="logout" href="admin.php">Admin Panel</a><?php endif; ?>
<a class="logout" href="logout.php">Log out</a></aside>
